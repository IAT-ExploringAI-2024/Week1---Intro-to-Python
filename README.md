...
- You may want to use [Colab](https://colab.google/), [Jupyter Lab](https://jupyter.org/) or an IDE of your choice that can run Jupyter Notebooks for this assignment.
...
2. Fork the [repository](https://github.com/IAT-ExploringAI-2025/Week1-Intro-to-Python) to your github account.
